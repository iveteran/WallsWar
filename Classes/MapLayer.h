...
public:
    ...
    void createBlock(int i, int j, BlockType t);
    void createBlock(float x, float y, BlockType t);
    void createBlock(const cocos2d::Vec2& pos, BlockType t);

    void createBlocks(const std::vector<cocos2d::Vec2>& posList, BlockType t);

    void createBlock2(float x, float y, BlockType t, Direction dir);
    void createBlock2(const cocos2d::Vec2& pos, BlockType t, Direction dir);

    void createBlock4(int i, int j, BlockType t);
    void createBlock4(float x, float y, BlockType t);
    void createBlock4(const cocos2d::Vec2& pos, BlockType t);
...
private:
    ...
    void _addBlock(float x, float y, BlockType t);
